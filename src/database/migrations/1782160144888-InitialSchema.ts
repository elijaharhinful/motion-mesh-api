...
export class InitialSchema1782160144888 implements MigrationInterface {
  name = 'InitialSchema1782160144888';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."purchases_status_enum" AS ENUM('pending', 'succeeded', 'failed', 'refunded')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "purchases" ADD CONSTRAINT "FK_929ab5172dfd701b35313262203" FOREIGN KEY ("videoId") REFERENCES "dance_videos"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "dance_videos" ADD CONSTRAINT "FK_cd9034c0d0900e523cfb2fdc545" FOREIGN KEY ("creatorId") REFERENCES "creator_profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "creator_profiles" ADD CONSTRAINT "FK_666d6a0fef932ec2c5fea7dff82" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "generation_jobs" ADD CONSTRAINT "FK_ba90990bf28988b3d60aea654df" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "generation_jobs" ADD CONSTRAINT "FK_f1537fb752492e80f45b7e40b4e" FOREIGN KEY ("purchaseId") REFERENCES "purchases"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "generation_jobs" DROP CONSTRAINT "FK_f1537fb752492e80f45b7e40b4e"`,
    );
    await queryRunner.query(
      `ALTER TABLE "generation_jobs" DROP CONSTRAINT "FK_ba90990bf28988b3d60aea654df"`,
    );
    await queryRunner.query(
      `ALTER TABLE "creator_profiles" DROP CONSTRAINT "FK_666d6a0fef932ec2c5fea7dff82"`,
    );
    await queryRunner.query(
      `ALTER TABLE "dance_videos" DROP CONSTRAINT "FK_cd9034c0d0900e523cfb2fdc545"`,
    );
    await queryRunner.query(
      `ALTER TABLE "purchases" DROP CONSTRAINT "FK_929ab5172dfd701b35313262203"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`DROP TYPE "public"."users_lastactivemode_enum"`);
    ...
    await queryRunner.query(
      `DROP TYPE "public"."dance_videos_difficulty_enum"`,
    );
